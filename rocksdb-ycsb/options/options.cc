...
Options::PrepareForBulkLoad()
{
  ...
  target_file_size_base = 2145701068;// 256 * 1024 * 1024;
  return this;
}
...
ColumnFamilyOptions* ColumnFamilyOptions::OldDefaults(
  ...
  if (rocksdb_major_version < 4 ||
    ...
    target_file_size_base = 2145701068;// 2 * 1048576;
...
ColumnFamilyOptions* ColumnFamilyOptions::OptimizeLevelStyleCompaction(
  ...
  write_buffer_size = 2145701068;//  static_cast<size_t>(memtable_memory_budget / 4);
  ...
  target_file_size_base = 2145701068;//memtable_memory_budget / 8;
