...
// APPEND-DOC, we use these SZD structures
...
class Zone {
 ...
 public:
  ...
  // APPEND-DOC, new method for zone appends
...
class ZonedBlockDevice {
 private:
  ...
  // APPEND-DOC, new variables needed for SZD
